...
-- Nvim Tree
opts.desc = "NvimTreeToggle"
map.set( 'n', '<leader>ee', '<Cmd> NvimTreeToggle <CR>', opts )
opts.desc = "NvimTreeFocus"
...
map.set( 'n', '<leader>gg', '<Cmd>lua vim.lsp.buf.hover()<CR>', opts )
...
-- LazyGit
opts.desc = "Spawn LazyGit"
map.set( 'n', '<leader>lg', '<Cmd>LazyGit<CR>', opts )
...
map.set("n", '<leader>dd', function() require('dap').disconnect(); require('dapui').close(); end)
map.set("n", '<leader>dt', function() require('dap').terminate(); require('dapui').close(); end)
...
map.set("n", '<leader>d?', function() local widgets = require "dap.ui.widgets"; widgets.centered_float(widgets.scopes) end)
